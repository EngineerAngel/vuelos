...
$sql = 'SELECT aerolinea, num_vuelo, dias_operacion, horario_salida, clase, tarifa_ow, tarifa_rf, restricciones FROM vuelos';
if ($where) {
...
<head>
    ...
    <title>Sistema de Reservaciones - Resultados Tarifas</title>
</head>
<body>
<center>
    <h1>SISTEMA DE RESERVACIONES DE VUELO</h1>
    <h2>Pantalla Resultado Tarifas (P-11)</h2>
    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($v['clase']) ?></td>
                <td><?= htmlspecialchars($v['tarifa_ow']) ?></td>
                <td><?= htmlspecialchars($v['tarifa_rf']) ?></td>
                <td><?= htmlspecialchars($v['restricciones']) ?></td>
            </tr>
            <?php endforeach; ?>
            <?php for ($i = count($vuelos); $i < 10; $i++): ?>
            <tr><td><input type="checkbox"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
            <?php endfor; ?>
        </tbody>
    </table>
    ...
    <button type="button">-</button>
    <a href="form_consultas.php"><button type="button">Nueva Consulta</button></a>
