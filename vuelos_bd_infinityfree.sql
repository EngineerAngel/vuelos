-- Base de datos: Sistema de Reservaciones de Vuelo (versión InfinityFree)
-- IMPORTANTE: Antes de importar este archivo, crea la base de datos desde el
-- panel de control de InfinityFree (sección "MySQL Databases") y luego
-- selecciónala en phpMyAdmin antes de importar.
...
CREATE TABLE IF NOT EXISTS reservas (
    clave_reserva       INT AUTO_INCREMENT PRIMARY KEY,
    id_usuario          INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagos (
    ...
    fecha_vencimiento   VARCHAR(7),
    tarifa              DECIMAL(10,2),
    tipo_operacion      ENUM('pago','reembolso') NOT NULL,
